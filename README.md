...
pnpm run test:v3     # zod3 line: 49 unit tests + 20 000-case differential fuzz against stock zod3 (ordered issue lists included), run with the generated and the closure skeletons
...
packages/zod-cow-v3/        private zod-cow-v3; exports the TypeScript source, no build
  ...
  tests/unit.test.ts        zod3 unit tests (49, --no-codegen for the closure fallback)
